        ...
        <PasswordBody>
            <PasswordBodyUpper>
                ...
                <Box>
                    ...
                    <PasswordTitle2>Please enter the <span style={{color: "#FFB7C0"}}>email</span> and find your <span style={{color: "#FFB7C0"}}>Happiness</span></PasswordTitle2>
                </Box>
            </PasswordBodyUpper>
            ...
            <div class={password.signinButtonbox}>
                <button type='button' class={password.signinButton}>비밀번호 변경</button>

                <Box class={password.otherButtonbox}>
                    <Link to="/login" class={password.loginButton}>Back to Login page</Link>
                    <Link to="/signin" class={password.forgotpasswordButton}>Back to Signin page</Link>
                </Box>
            </div>
